...
select d.name, e.name, e.departments_id from employees e left join departments d on e.departments_id = d.id;
select d.name, e.name, e.departments_id from departments d right join employees e on d.id = e.departments_id;

select d.name, e.name, e.departments_id from departments d left join employees e on d.id = e.departments_id;
select d.name, e.name, e.departments_id from employees e right join departments d on e.departments_id = d.id;
